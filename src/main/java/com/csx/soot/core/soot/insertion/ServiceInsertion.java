...
public class ServiceInsertion{
    ...
    public void serviceInsertion(final Map<String, List<String>> manifestMap,
                                 final Map<String, String> serviceCheckMap){
        PackManager.v().getPack("jtp").add(new Transform("jtp.my.service.insertion", new BodyTransformer(){
            ...
            protected void internalTransform(Body body, String s, Map<String, String> map){
                ...
                if (manifestMap.get("services").contains(className)){
                    ...
                    // 插装FINISHED语句
                    insertString = body.getMethod().getDeclaringClass().getName() + "#" + body.getMethod().getName() +
                                   " @FINISHED";
